...
class Poliza(BasePoliza):
    ...
    class Meta:
        ...
        verbose_name = "póliza"
        permissions = (
            ("trust_clientes_natural", "Clientes Naturales(trustseguros)"),
            ("trust_clientes_juridico", "Clientes Jurídicos(trustseguros)"),
            ("trust_polizas_poliza", "Pólizas(trustseguros)"),
            ("trust_polizas_tramite", "Trámites(trustseguros)"),
            ("trust_catalogos_aseguradora", "Catálogos Aseguradoras(trustseguros)"),
            ...
            ("trust_usuarios_grupo", "Perfiles y Roles(trustseguros)"),
            ("trust_crm_oportunidad", "CRM Oportunidades(trustseguros)"),
            ("trust_gestion_recibo", "Gestión de recibos(trustseguros)"),
        )
    ...
    def prima_total(self):
        return round(self.cuotas().aggregate(Sum('monto'))['monto__sum'], 2) or 0.0

# Generated by Django 2.1.3 on 2020-01-22 04:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='perfilempleado_departamento', to='utils.Departamento')),
                ('entidad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cotizador.Entidad')),
                ('municipio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='perfilempleado_municipio', to='utils.Municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iva', models.FloatField(default=0.0)),
                ('total', models.FloatField(default=0.0)),
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tickets_cliente', to='cotizador.Cliente')),
        ...
        migrations.AddField(
            ...
            name='empleado',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='beneficiarios_bensepelio', to='cotizador.Cliente'),
        ),
        migrations.AddField(
            model_name='bensepelio',
            name='orden',
        ...
        migrations.AddField(
            ...
            name='empleado',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='beneficiarios_benaccidente', to='cotizador.Cliente'),
        ),
        migrations.AddField(
            model_name='benaccidente',
            name='orden',

...
class EstadoSiniestros:
    ...
    @classmethod
    def choices(cls):
        return (None, '---------'), (cls.REGISTRADO, 'Registrado'), (cls.ENVIADO, 'Enviado'), (cls.LIQUIDADO, 'Liquidado'), \
...
class Siniestro(Base):
    ...
    asegurado_certificado = models.CharField(max_length=30, null=True, blank=True, verbose_name="Asegurado / Certificado")
    descripcion = models.TextField(max_length=600, null=True, blank=True)
    ...
    contacto_aseguradora = models.ForeignKey(ContactoAseguradora, null=True, on_delete=models.SET_NULL, blank=True)
    tramite = models.ForeignKey('SiniestroTramite', null=True, blank=True, on_delete=models.SET_NULL, related_name="tramite_seleccionado")

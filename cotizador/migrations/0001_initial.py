    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='name')),
                ('active', models.BooleanField(default=True)),
                ('departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='municipios', to='cotizador.Departamento')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cotizador.Departamento')),
                ('entidad', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='cotizador.Entidad')),
                ('municipio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cotizador.Municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_cobertura', models.CharField(blank=True, max_length=165, null=True)),
                ...
                ('medio_pago', models.CharField(blank=True, max_length=25, null=True)),
            ...
            options={
                ...
                'permissions': (('report_debito_automatico', 'report_debito_automatico'), ('report_cotizaciones', 'report_cotizaciones')),
            },
        ),
        migrations.CreateModel(
            name='Referencia',
